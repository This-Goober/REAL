...
- The strongest opening for this series is a **sensation, not a claim** — for a
  ...
  thing itself (see `claude/drone-60s-cut.md`).
...
- **Never estimated.** A demo carries an explicit duration from [director]. If he has
  not given one, that is a question in the plan, not a default you invent.
...
Do not cut it yourself. Present the options and let him choose:
